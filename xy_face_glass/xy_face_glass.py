...
PREDICTOR_FILE = res + '/data/shape_predictor_68.dat'
DEAL_IMG = res + '/data/deals.png'
TEXT_IMG = res + '/data/text.png'
...
def generate_gif(filename=''):
    ...
    deal = Image.open(DEAL_IMG)
    text = Image.open(TEXT_IMG)
